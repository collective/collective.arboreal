...
class MultiTreeSelectionWidget(MultiSelectionWidget):
    ...
    def render_own_label(self):
        """ We do not want to render our own label thank you """
        return False

registerWidget(
    MultiTreeSelectionWidget,
    title='Multi Tree Selection',
    description=('Selection widget that allows you to select multiple items'
                 ' from an Arboreal tree.'),
...
registerWidget(
    ...
    description=('Selection widget that allows you to select one'
                 ' item from an Arboreal tree.'),
